...
# character classes and matching regex filter۱۲۳۴۵۶۷۸۹
regex = r'^[a-z ]+$'
...
def paint_text(text, w, h, rotate=False, ud=False, multi_fonts=False):
    ...
    with cairo.Context(surface) as context:
        ...
        if multi_fonts:
            ...
            #fonts = ['Geeza Pro', 'Nadeem', 'Al Bayan', 'DecoType Naskh', 'DejaVu Serif', 'STFangsong', 'STHeiti', 'STKaiti', 'STSong', 'AB AlBayan', 'AB Geeza', 'AB Kufi', 'DecoType Naskh','Aldhabi', 'Andalus', 'Sakkal Majalla', 'Simplified Arabic2','Traditional Arabic', 'Arabic Typesetting', 'Urdu Typesetting', 'Droid Naskh', 'Droid Kufi', 'Roboto', 'Tahoma', 'Times New Roman2', 'Arial']
            #fonts = ['Arabic','Arabic Supplement','Arabic Presentation Forms-A','Arabic Presentation Forms-B','Tahoma']
...
"""def text_to_labels(text):
    ...
    for char in text:
        ...
        elif (char >= u'\uFB50' and char <= u'\uFDFF'):
            ret.append(ord(char) - ord(u'\uFB50'))
...
def is_valid_str(in_str):
    rege = r'^[\u0600-\u06FF\uFB8A\u067E\u0686\u06AF\u200C\u200F ]+$'
    """search = re.compile(rege, re.UNICODE).search
    return bool(search(in_str))"""
    #search = re.compile(r'^[\u0600-\u06FF\uFB8A\u067E\u0686\u06AF\u200C\u200F\uFBD3\uFBB2\uFE70\uFE80 ]+$').search   
    #search = re.compile(r'^[\u0600-\u06FF\uFB8A\u200C\u200F\uFB50-uFDFF ]+$').search   
